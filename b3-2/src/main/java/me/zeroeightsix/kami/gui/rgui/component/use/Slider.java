...
public class Slider extends AbstractComponent
{
    ...
    public void setValue(final double value) {
        ...
        this.value = (this.integer ? ((double)(int)info.getNewValue()) : info.getNewValue());
    }
    ...
    public abstract static class SliderPoof<T extends Component, S extends SliderPoof.SliderPoofInfo> extends Poof<T, S>
    {
