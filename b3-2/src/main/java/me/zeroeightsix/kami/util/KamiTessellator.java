...
//        GlStateManager.blendFunc(GlStateManager.SourceFactor.ONE, GlStateManager.DestFactor.ZERO);
    ...
    public static void drawBoundingBox(AxisAlignedBB offset, float v, Integer value, Integer value1, Integer value2, Integer value3) {
    }

    public static void drawFullBox(AxisAlignedBB offset, BlockPos blockPos, float v, Integer value, Integer value1, Integer value2, Integer value3) {
    }

    public static void drawFace(BlockPos blockPos, Integer value, Integer value1, Integer value2, Integer value3, int i) {
    }

    public static void drawBoundingBoxFace(AxisAlignedBB offset, float v, Integer value, Integer value1, Integer value2, Integer value3) {
    }
}
