...
public class CrystalAura extends Module {
	...
	private Setting<Boolean> thing = register(Settings.b("MutltiPlace", true));
	...
	private Setting<Double>  Pdelay = register(Settings.d("Place Delay", 1));
	private Setting<Double>  Bdelay = register(Settings.d("Break Delay", 1));
	...
	private Setting<Integer> MinDmg = register(Settings.integerBuilder("Min Dmg").withMinimum(0).withMaximum(16).withValue(2));
    ...
    public void onUpdate() {
        ...
        if (explode.getValue() && crystal != null && mc.player.getDistance(crystal) <= range.getValue()) {
            ...
            if (((System.nanoTime() / 1000000) - systemTime) >= Bdelay.getValue()) {
    ...
    public void onWorldRender(RenderEvent event) {
        if (render != null) {
            ...
            KamiTessellator.drawBox(render, Red.getValue().intValue(), Green.getValue().intValue(), Blue.getValue().intValue(), Alpha.getValue().intValue(), GeometryMasks.Quad.ALL);
